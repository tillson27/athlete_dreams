...
export const mockAthletes: MockAthlete[] = [
    ...
    campaigns: [
      {
        ...
        campaignType: 'EVENT',
        campaignStory:
          'I qualified at Boston this spring, barely. Tokyo is the last Major I need to complete the set, and the field is brutal. Every dollar gets me one block closer to the start line.',
  ...
  },
  {
    ...
    bio: 'I lost my left leg in a snowmobile accident at 17. Six years later, I race marathons on a running blade, with a 3:04 in Montréal and a para 5000m national title so far. I run for every kid sitting in a hospital wondering what is next.',
    primarySport: 'RUNNING',
    ...
    campaigns: [
      ...
      },
      {
        ...
        campaignType: 'GEAR',
        campaignStory:
          'My current blade is three seasons and 8,000 km old. The new model returns more energy per stride, and over a marathon that is minutes.',
    ...
    campaigns: [
      {
        ...
        campaignType: 'SEASON',
        campaignStory:
          'Fast 1500s happen in fast fields, and fast fields mean flying to them. This season is Victoria, Vancouver, Toronto, and a European tune-up, all of it chasing four seconds.',
