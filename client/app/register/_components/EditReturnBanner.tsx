...
export function EditReturnBanner() {
  return (
    <div className="mb-8 flex flex-col items-start gap-3 rounded-xl border border-secondary/30 bg-secondary-container/30 px-5 py-3 sm:flex-row sm:items-center sm:justify-between">
      <p className="label-bold flex items-center gap-2 text-on-secondary-container">
