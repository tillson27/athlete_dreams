...
import {
  readPrototypeOnboardingProfile,
  writePrototypeOnboardingProfile,
} from '@/lib/prototype/onboarding';
...
export function OnboardingProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const saved = readPrototypeOnboardingProfile<Partial<OnboardingProfile>>();
  ...
  useEffect(() => {
    if (!hydrated) return;
    writePrototypeOnboardingProfile(profile);
  }, [profile, hydrated]);
