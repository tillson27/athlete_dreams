    ...
    <SlideShell eyebrow="Market">
      ...
      <div className="mt-6 grid flex-1 grid-cols-3 gap-4">
        <div className="rounded-2xl border border-outline-variant/70 bg-surface-container-lowest p-5">
          <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-on-surface">TAM · 2030</p>
        ...
        <div className="rounded-2xl border border-primary/30 bg-primary-soft/40 p-5">
          <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-on-surface">SAM · 2028</p>
        ...
        <div className="rounded-2xl border border-outline-variant/70 bg-surface-container-lowest p-5">
          <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-on-surface">SOM · Year 3</p>
