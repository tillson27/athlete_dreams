    ...
    <div className="relative flex h-full w-full flex-col justify-between gap-6 overflow-hidden bg-inverse-surface px-16 py-14 text-white">
      ...
      <div className="relative">
        ...
        <p className="mt-6 max-w-3xl text-xl leading-snug text-white/75">
          ARC is the world&rsquo;s most transparent funding platform for athletes &mdash; crowdfunding,
      ...
      <div className="relative flex flex-wrap items-end justify-end gap-6 text-sm text-white/65">
        <div className="flex flex-col text-right">
          <span className="text-[10px] uppercase tracking-[0.2em] text-white/45">Network</span>
          <span className="text-white">arc.network</span>
        </div>
      </div>
    </div>
  ),
