...
export function AthleteProfile({
  ...
  const hasTrainingSnapshot = Boolean(
    profile.training.weeklyKm ||
      ...
      profile.training.weeklyGain ||
      profile.training.weeklyLoad ||
      profile.training.latestTitle ||
      profile.training.latestMeta
  );
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="rounded bg-secondary-soft px-2 py-1 text-[10px] font-bold tracking-[0.05em] text-secondary">
                  {hasTrainingSnapshot ? 'THIS WEEK' : 'COMING SOON'}
                </span>
              </div>
              {hasTrainingSnapshot ? (
                <>
                ...
                <div className="rounded-input border border-dashed border-outline-variant bg-surface-container-low/50 p-4 text-sm font-semibold text-on-surface-variant">
                  Training snapshot coming soon.
                </div>
              )}
            </div>
