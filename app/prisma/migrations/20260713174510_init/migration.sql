...
-- CreateIndex
CREATE INDEX "athlete_profiles_publishedAt_createdAt_id_idx" ON "athlete_profiles"("publishedAt", "createdAt", "id");

-- CreateIndex
CREATE INDEX "athlete_profiles_primarySport_publishedAt_createdAt_id_idx" ON "athlete_profiles"("primarySport", "publishedAt", "createdAt", "id");

-- CreateIndex
CREATE INDEX "athlete_profiles_runnerLevel_publishedAt_createdAt_id_idx" ON "athlete_profiles"("runnerLevel", "publishedAt", "createdAt", "id");

-- CreateIndex
CREATE INDEX "athlete_profiles_countryCode_publishedAt_createdAt_id_idx" ON "athlete_profiles"("countryCode", "publishedAt", "createdAt", "id");
...
-- CreateIndex
CREATE INDEX "follows_followerUserId_createdAt_idx" ON "follows"("followerUserId", "createdAt");
...
-- CreateIndex
CREATE INDEX "campaigns_campaignStatus_createdAt_id_idx" ON "campaigns"("campaignStatus", "createdAt", "id");

-- CreateIndex
CREATE INDEX "campaigns_athleteId_campaignStatus_createdAt_id_idx" ON "campaigns"("athleteId", "campaignStatus", "createdAt", "id");

-- CreateIndex
CREATE INDEX "campaigns_athleteEventId_idx" ON "campaigns"("athleteEventId");
...
-- CreateIndex
CREATE INDEX "brand_memberships_userId_idx" ON "brand_memberships"("userId");
...
-- CreateIndex
CREATE INDEX "ambassador_applications_applicant_status_idx" ON "ambassador_applications"("applicantAthleteId", "ambassadorApplicationStatus");
...
-- AddForeignKey
ALTER TABLE "ambassador_applications" ADD CONSTRAINT "ambassador_applications_applicantAthleteId_fkey" FOREIGN KEY ("applicantAthleteId") REFERENCES "athlete_profiles"("id") ON DELETE CASCADE ON UPDATE CASCADE;
