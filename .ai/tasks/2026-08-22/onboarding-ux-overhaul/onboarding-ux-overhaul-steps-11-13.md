...
* [ ] Run the verification walkthrough above and record the result in the completion notes
* [ ] Run the constraint audit above
...
* [ ] Move `.ai/tasks/2026-08-22/onboarding-ux-overhaul/` to `.ai/tasks/2026-08-22/completed/onboarding-ux-overhaul/`
- [ ] Ask user for next action (commit, continue, etc.) (**OVERRIDE:** When executing the step within the `$step-loop` (`/step-loop`) skill, do **NOT** ask the user for next action. **ALWAYS** commit the fully completed step. **GOAL**: One commit per step.)
