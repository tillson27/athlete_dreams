...
**Completed At:** 2026-07-19
**Completion Notes:**
- Removed Discipline and Level filters from `/athletes`, kept search plus Region, added 12-per-page URL-synced pagination, and updated the page metadata to match.
...
**Completed At:** 2026-07-19
**Completion Notes:**
- Added a native-dialog photo carousel with close, desktop arrow-key/navigation buttons, and mobile swipe support; gallery tiles are now buttons that open the carousel at the selected image.
