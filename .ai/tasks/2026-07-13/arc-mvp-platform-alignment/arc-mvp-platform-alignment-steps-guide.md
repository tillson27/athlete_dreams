...
- `.ai/tasks/2026-07-13/arc-mvp-platform-alignment/arc-mvp-platform-alignment-context.md`

**Steps docs (max 5 steps per doc):**
- `.ai/tasks/2026-07-13/arc-mvp-platform-alignment/arc-mvp-platform-alignment-steps-1-5.md`
- `.ai/tasks/2026-07-13/arc-mvp-platform-alignment/arc-mvp-platform-alignment-steps-6-10.md`
- `.ai/tasks/2026-07-13/arc-mvp-platform-alignment/arc-mvp-platform-alignment-steps-11-12.md`
...
| 10 | Replace mock auth and browser persistence with durable flows | Incomplete | AI agent | `.ai/tasks/2026-07-13/arc-mvp-platform-alignment/arc-mvp-platform-alignment-steps-6-10.md` |
| 11 | Update docs, seeds, and operational guardrails | Incomplete | AI agent | `.ai/tasks/2026-07-13/arc-mvp-platform-alignment/arc-mvp-platform-alignment-steps-11-12.md` |
| 12 | Final validation & cleanup | Incomplete | AI agent | `.ai/tasks/2026-07-13/arc-mvp-platform-alignment/arc-mvp-platform-alignment-steps-11-12.md` |
