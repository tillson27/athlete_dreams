...
| 2 | App bootstrap refactor: buildApp split, lifecycle, health | Incomplete | unassigned | `.ai/tasks/2026-07-13/backend-foundation-test-deploy/backend-foundation-test-deploy-steps-1-5.md` |
...
| 5 | Zod contract evolution in common/ | Incomplete | unassigned | `.ai/tasks/2026-07-13/backend-foundation-test-deploy/backend-foundation-test-deploy-steps-1-5.md` |
